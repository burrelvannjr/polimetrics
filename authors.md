...
Source:
[`DESCRIPTION`](https://github.com/burrelvannjr/polimetrics/blob/main/DESCRIPTION)

Vann Jr B (2026). *polimetrics: R Tools for Political Measures*. R
package version 1.2.1.23, <https://github.com/burrelvannjr/polimetrics>.
    ...
    @Manual{,
      ...
      url = {https://github.com/burrelvannjr/polimetrics},
    }
